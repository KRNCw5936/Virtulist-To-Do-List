...
<div class="container">
    ...
    <div class="card shadow-sm position-relative" style="border-radius: 15px; overflow: hidden;">
        <div class="card-body d-flex flex-column align-items-center justify-content-center text-white position-relative"
            ...
            <h3 class="fw-bold fs-2 position-relative">Selamat Datang di VIRTULIST</h3>
    ...
    <section class="mt-4">
        ...
        <div class="card-container">
            <div class="card">
                <div class="card-title">Total Task List</div>
            ...
            <div class="card">
                <div class="card-title">Task List Selesai</div>
            ...
            <div class="card">
                <div class="card-title">Task Berlangsung</div>
    ...
    <section class="chart-container">
        <div class="chart-box">
            <h3 class="chart-title">Statistik Berdasarkan Status</h3>
            <div class="chart">
        ...
        <div class="chart-box">
            <h3 class="chart-title">Distribusi Task</h3>
            <div class="chart">
